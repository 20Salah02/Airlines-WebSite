...
export default function BusinessClass({onSelect} : BusClassProps){
    ...
    return(
        <div
            ref={sliderRef}
            className="
                flex overflow-x-auto overflow-y-hidden snap-x snap-mandatory scroll-smooth gap-4 lg:grid lg:grid-cols-3 lg:overflow-visible"
        >
            <div className="snap-center min-w-[85%] lg:min-w-0 border border-gray-200 rounded-3xl py-4 lg:px-4 px-2 h-170">
                <div>
                    <h1 className="lg:text-[25px] text-[23px] font-light text-gray-600">Business Comfort</h1>
                ...
                <div className="text-zinc-800 font-light">
                    ...
                    <ul className="lg:space-y-6 space-y-4 mt-4">
                        ...
                        <li className="flex items-start space-x-1.5">
                            ...
                            <h3 className="lg:text-[16px] text-[14px]">Checked baggage: 40 kg</h3>
                        </li>
                        <li className="flex items-start space-x-1.5">
                            ...
                            <h3 className="lg:text-[16px] text-[14px]">Hand baggage: 2 piece, 15 kg</h3>
                        </li>
                        <li className="flex items-start space-x-1.5">
                            ...
                            <h3 className="lg:text-[16px] text-[14px]">Seat selection included</h3>
                        </li>
                        <li className="flex items-start space-x-1.5">
                            <svg className="w-6 h-6 mt-1 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="2" d="M5 5.997C5 5.447 5.45 5 6.007 5h11.986C18.55 5 19 5.453 19 5.997V13H5zM22 8v7.003c0 .55-.455.997-.992.997H2.992A1 1 0 0 1 2 15.003V8m3 8v2zm14 0v2z"/></svg>
                            <h3 className="lg:text-[16px] text-[14px]">Lounge access included</h3>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="snap-center min-w-[85%] lg:min-w-0 border border-gray-200 rounded-3xl py-4 lg:px-4 px-2 h-170">
                <div>
                    <h1 className="lg:text-[25px] text-[23px] font-light text-gray-600">Business Elite</h1>
                    <div className="lg:mt-5 mt-2">
                        <h2 className="flex justify-end text-3xl lg:font-[350] font-light py-2">{format(elitePrice)}</h2>
                        <h3 className="flex justify-end text-gray-600">Total for All Passengers</h3>
                    </div>
                    <h4 
