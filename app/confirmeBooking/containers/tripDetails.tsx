...
export default function TripDetails(){
    ...
    return(
        <div className="flex flex-col bg-white w-2/5 p-6 mt-20 rounded-3xl space-y-2.5">
            <div className="space-y-2">
                <h1 className="font-medium text-[19px]">Trip details</h1>
                <p>Return Trip</p>
            </div>
            <div>
                <div className="flex justify-between items-center border-b border-b-gray-300 py-2.5 cursor-pointer">
                    <div className="space-y-1">
                        <h2 className="text-[18px] font-medium">Doha to Jakarta</h2>
                ...
                <div className="flex justify-between items-center border-b border-b-gray-300 py-2.5 cursor-pointer">
                    <div className="space-y-1">
                        <h2 className="text-[18px] font-medium">Jakarta to Doha</h2>
            ...
            <div className="flex flex-col py-2">
                <div className="flex justify-between  space-y-1">
                    ...
                    <h3 className="font-medium text-[18px]">MAD 2,000</h3>
                </div>
